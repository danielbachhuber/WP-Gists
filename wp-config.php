...
$wpgists_constant_defaults = array(
	'DB_NAME'            => '',
	'DB_USER'            => '',
	'DB_PASSWORD'        => '',
	'DB_HOST'            => 'localhost',
	...
	'LOGGED_IN_SALT'     => '',
	'NONCE_SALT'         => '',
	'WP_SITEURL'         => 'http://wpgists.org/wp',
	'WP_HOME'            => 'http://wpgists.org'
	);

foreach( $wpgists_constant_defaults as $key => $value ) {
	if ( ! defined( $key ) ) {
		define( $key, $value );
	}
}
...
// Set default theme.
define( 'WP_DEFAULT_THEME', 'wpgists' );
